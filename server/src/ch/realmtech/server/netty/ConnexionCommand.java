...
@Command(name = "connexionConfiguration", description = "Server launcher configuration ", version = "0.2", mixinStandardHelpOptions = true)
public class ConnexionCommand implements Callable<ConnexionConfig> {
    ...
    public ConnexionConfig call() throws Exception {
        return ConnexionConfig.builder()
                ...
                .setNotVerifyAccessToken(notVerifyAccessToken)
